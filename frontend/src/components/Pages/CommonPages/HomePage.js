    ...
    return (
        <div className={'home-page-div'}>
            ...
            <h2 className={'about-text'}>Welcome to our cleaning service page, where we offer a range of professional cleaning services that cater to your
                ...
                cleaned thoroughly and efficiently, leaving you with more time to focus on other important tasks. <br/>Our cleaning services provide a range of
                benefits that can improve your daily life. For instance, by hiring our cleaning service, you save time and energy that would otherwise be spent
                on cleaning. Our team is equipped with the necessary tools and equipment to ensure that your home or office is cleaned to the highest standards.
                <br/>We understand the importance of a clean and healthy environment, and that is why we use eco-friendly cleaning products that are safe for
                ...
                customized services that cater to your specific needs, whether you need daily, weekly, or monthly cleaning, or specialized services like carpet
                ...
                apartment.
                <br/>We offer a range of cleaning services that include basic cleaning tasks like dusting, vacuuming, and mopping, as well as more specialized
            ...
            {users && (<div>
                <h1 className={'about-text'}>Our best 5 employee</h1>
